 <?php
  ...
  echo "Error while uploading";
		...
		$sql = "insert into posts (author,date,image) values ('$author',CURRENT_TIMESTAMP,'$filename');";
      ...
      <div class="portfolio-items">
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P01.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P01.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 illustration">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P03.jpg"  data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P03.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P06.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P06.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P07.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P07.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 illustration">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P08.jpg"  data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P08.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P10.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P10.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P12.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P12.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P13.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P13.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 illustration">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P18.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P18.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P19.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P19.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P23.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P23.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../img/P25.jpg" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <!--<h4>Project Title</h4>-->
              </div>
              <img src="../img/P25.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
      </div>
    		<form id="post-form"  name="post-form" accept-charset="utf-8" action="https://yyprojects.online/espacedesign/index.html" method="post" enctype="multipart/form-data">

    
				<input type="file" name="image" placeholder="Upload Featured Image"/><br><br>
